Consider the following problem. You have an array A[0], A[1], …, A[n - 1] of distinct integers that has the following property: The values in the array increase up to index p for some p,
